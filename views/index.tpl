...
<style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    /* Export button - disabled for public */
...
<div class="container-fluid py-5 px-4">
    <div class="mb-4 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-3 align-items-center">
            ...
            % else:
                <span class="action-control-btn export-variant disabled" title="Login required to export data">
                    <i class="fas fa-file-csv"></i> Export CSV
                </span>
            % end
        </div>
                    ...
                    <table id="resultsTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                % else:
                                <td><div class="table-cell-content audit-target" data-full="{{ c['P'] }}" style="color: #ffaa00;">{{ c['P'][:2] + '****' + c['P'][-2:] if c['P'] and len(c['P']) > 4 else c['P'] }}</div></td>
                                % end
